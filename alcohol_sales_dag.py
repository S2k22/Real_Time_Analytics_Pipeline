...
def calculate_file_checksum(filepath):
    ...
    Returns:
        str: Hexadecimal representation of the file's checksum
    """
...
def ingest_data(**kwargs):
    """
    Find the original data file, copy it to staging directory only if not already processed,
    and use the staged copy for further processing
    """
